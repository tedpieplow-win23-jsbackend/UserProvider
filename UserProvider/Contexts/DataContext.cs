...
namespace UserProvider.Contexts;
...
public partial class DataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasIndex(e => e.ApplicationUserId, "IX_UserCourses_ApplicationUserId");

            entity.HasOne(d => d.ApplicationUser).WithMany(p => p.UserCourses).HasForeignKey(d => d.ApplicationUserId);
        });
